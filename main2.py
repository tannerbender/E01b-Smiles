...
arcade.draw_ellipse_filled(face_x -25, face_y + 20, 15, 25, open_color.black)
arcade.draw_ellipse_filled(face_x + 25, face_y + 20, 15, 25, open_color.black)
arcade.draw_circle_filled(face_x - 21, face_y + 25, 3, open_color.gray_2)
arcade.draw_circle_filled(face_x + 29, face_y + 25, 3, open_color.gray_2)
